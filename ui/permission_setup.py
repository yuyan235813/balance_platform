...
class Ui_permissionSetupForm(object):
    def setupUi(self, permissionSetupForm):
        ...
        self.superLineEdit = QtWidgets.QLineEdit(permissionSetupForm)
        self.superLineEdit.setMaxLength(6)
        self.superLineEdit.setEchoMode(QtWidgets.QLineEdit.Password)
        self.superLineEdit.setObjectName("superLineEdit")
        self.horizontalLayout_4.addWidget(self.superLineEdit)
