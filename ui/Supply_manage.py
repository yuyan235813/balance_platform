...
class Ui_supplyManageForm(object):
    def setupUi(self, supplyManageForm):
        supplyManageForm.setObjectName("Form")
        ...
        self.SupplyPhoneLineEdit.setObjectName("SupplyContactLineEdit")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(90, 390, 491, 41))
    ...
    def retranslateUi(self, supplyManageForm):
        ...
        supplyManageForm.setWindowTitle(_translate("supplyManageForm", "供货单位"))
        ...
        self.savePushButton.setText(_translate("supplyManageForm", "保存"))
